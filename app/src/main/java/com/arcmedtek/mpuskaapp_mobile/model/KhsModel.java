...
public class KhsModel {
    ...
    public int get_idCpmk() {
        return _idCpmk;
    }

    public void set_idCpmk(int _idCpmk) {
        this._idCpmk = _idCpmk;
    }
